...
typedef enum SSCheckBoxViewStyle_ {
    ...
    kSSCheckBoxViewStyleCustom,
    kSSCheckBoxViewStyleCustom2,
    kSSCheckBoxViewStyleCustom3,
    kSSCheckBoxViewStyleCustom4,
...
@property (nonatomic, assign)   BOOL textColorChange;
