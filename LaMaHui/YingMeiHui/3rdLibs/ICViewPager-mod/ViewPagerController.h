...
@property(nonatomic,strong) id<ViewPagerDataSource> dataSource;
@property(nonatomic,strong) id<ViewPagerDelegate> delegate;
...
- (void)reloadData;
- (void)selectedTabIndex:(NSInteger)index;//add by kevin on 2014.08.26 pm 14:30
@end
