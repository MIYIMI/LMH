...
public:
    ...
    void ref (NSInteger delta = 1) const
    {
        if(_syms)
...
public:
    ...
    class Point {
    public:
        NSInteger x;  ///< x-coordinate.
        NSInteger y;  ///< y-coordinate.

        Point () { }

        Point(NSInteger x, NSInteger y)
            : x(x), y(y)
        { }
    ...
    /// @since 0.11
    NSInteger get_orientation () const
    {
