...
class Processor {
 public:
    ...
    /// @since 0.4
    NSInteger set_config (zbar_symbol_type_t symbology,
    ...
    /// @since 0.4
    NSInteger set_config (std::string cfgstr)
    {
    ...
    bool is_visible ()
    {
        NSInteger rc = zbar_processor_is_visible(_processor);
        if(rc < 0)
            throw_exception(_processor);
        return(rc != 0);
    }
    ...
    NSInteger user_wait (NSInteger timeout = FOREVER)
    {
        NSInteger rc = zbar_processor_user_wait(_processor, timeout);
        if(rc < 0)
            throw_exception(_processor);
        return(rc);
    }
    ...
    void process_one (NSInteger timeout = FOREVER)
    {
    ...
    /// @since 0.6
    void request_size (NSInteger width, NSInteger height)
    {
    ...
    /// @since 0.6
    void request_interface (NSInteger version)
    {
    ...
    /// @since 0.7
    void request_iomode (NSInteger iomode)
    {
